...
type FloodEntity struct {
	name    string
	client  *core.GlobalFloodSDK
...
func NewFloodEntity(client *core.GlobalFloodSDK, entopts map[string]any) *FloodEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FloodEntity) GetName() string { return e.name }
...
func (e *FloodEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FloodEntity) Deleted() bool {
	return e.deleted
}


func (e *FloodEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFloodEntity(e.client, opts)
}

func (e *FloodEntity) Data(args ...any) any {
...
func (e *FloodEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Flood; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FloodEntity) DataTyped(data ...Flood) Flood {
	if len(data) > 0 {
		return typedFrom[Flood](e.Data(asMap(data[0])))
	}
	return typedFrom[Flood](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Flood (all fields
// optional at the wire level).
func (e *FloodEntity) MatchTyped(match ...Flood) Flood {
	if len(match) > 0 {
		return typedFrom[Flood](e.Match(asMap(match[0])))
	}
	return typedFrom[Flood](e.Match())
}
...
func (e *FloodEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FloodEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FloodLoadMatch and returns an Flood. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FloodEntity) LoadTyped(reqmatch FloodLoadMatch, ctrl map[string]any) (Flood, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Flood{}, err
	}
	return typedFrom[Flood](res), nil
}



func (e *FloodEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FloodEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FloodEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FloodEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FloodEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
