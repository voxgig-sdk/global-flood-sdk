...
// instead of `sdk.NewGlobalFloodSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *GlobalFloodSDK  { return NewGlobalFloodSDK(nil) }
func Test() *GlobalFloodSDK { return TestSDK(nil, nil) }
