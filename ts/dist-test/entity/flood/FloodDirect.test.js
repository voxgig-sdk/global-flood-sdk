...
(0, node_test_1.describe)('FloodDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.GlobalFloodSDK({
    ...
    (0, node_test_1.test)('direct-load-flood', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-flood', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.GLOBAL_FLOOD_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.GlobalFloodSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.GLOBAL_FLOOD_APIKEY,
        }));
        let idmap = env['GLOBAL_FLOOD_TEST_FLOOD_ENTID'];
    ...
    const client = new __1.GlobalFloodSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=FloodDirect.test.js.map