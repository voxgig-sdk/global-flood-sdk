...
function envOverride(m) {
    if ('TRUE' === process.env.GLOBAL_FLOOD_TEST_LIVE ||
        'TRUE' === process.env.GLOBAL_FLOOD_TEST_OVERRIDE) {
    ...
    m.GLOBAL_FLOOD_TEST_EXPLAIN = process.env.GLOBAL_FLOOD_TEST_EXPLAIN || m.GLOBAL_FLOOD_TEST_EXPLAIN;
    return m;
}
