// Command GlobalFlood-mcp is an MCP server exposing the GlobalFlood
// SDK as MCP tools.
//
// Two tools are registered:
//
//	GlobalFlood_list  — list records of an entity
//	GlobalFlood_load  — load a single record of an entity
//
