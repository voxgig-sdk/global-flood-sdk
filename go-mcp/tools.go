...
type Args struct {
	Entity string         `json:"entity" jsonschema:"flood"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GlobalFloodSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "global-flood_list",
		Description: "List records from GlobalFlood. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "global-flood_load",
		Description: "Load a single record from GlobalFlood. " +
...
func runOp(client *sdk.GlobalFloodSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GlobalFloodSDK, name string) (sdk.GlobalFloodEntity, error) {
	switch strings.ToLower(name) {
	case "flood":
		return client.Flood(nil), nil
