...
AQL-driven CLI and REPL for the GlobalFlood SDK. Positional arguments are
...
./global-flood-cli list flood
./global-flood-cli load 1 flood
./global-flood-cli load '{id:1}' flood
