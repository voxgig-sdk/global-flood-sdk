...
func registerSDKWords(r *eng.Registry, client *sdk.GlobalFloodSDK) {
...
func runOp(client *sdk.GlobalFloodSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
