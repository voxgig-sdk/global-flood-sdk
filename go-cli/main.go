// Command GlobalFlood-cli is a CLI + REPL for the GlobalFlood SDK,
...
const prompt = "global-flood"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "flood"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      GLOBAL_FLOOD_APIKEY (api key), GLOBAL_FLOOD_BASE (base url override)")
