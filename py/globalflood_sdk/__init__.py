...
from globalflood_sdk.utility import register

# Load features
from globalflood_sdk.feature.base_feature import GlobalFloodBaseFeature
from globalflood_sdk.features import _has_feature, _make_feature
...
class GlobalFloodSDK:
    ...
    def get_utility(self):
        return GlobalFloodUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GlobalFloodSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Flood(self, data=None) -> "FloodEntity":
        ...
        from globalflood_sdk.entity.flood_entity import FloodEntity
