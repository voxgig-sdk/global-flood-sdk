# GlobalFlood SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GlobalFloodSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GlobalFloodSDK(...) and GlobalFloodSDK.test(...) become
#      GlobalFloodSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "globalflood_sdk"
_SDK_CLASS = "GlobalFloodSDK"
