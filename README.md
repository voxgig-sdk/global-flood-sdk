...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/global-flood` | `npm install @voxgig-sdk/global-flood` |
| Python | `voxgig-sdk-global-flood` | `pip install voxgig-sdk-global-flood` |
| PHP | `voxgig-sdk/global-flood` | `composer require voxgig-sdk/global-flood` |
| Golang | `github.com/voxgig-sdk/global-flood-sdk/go` | `go get github.com/voxgig-sdk/global-flood-sdk/go` |
| Ruby | `voxgig-sdk-global-flood` | `gem install voxgig-sdk-global-flood` |
| Lua | `voxgig-sdk-global-flood` | `luarocks install voxgig-sdk-global-flood` |
