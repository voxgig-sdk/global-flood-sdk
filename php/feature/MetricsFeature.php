...
// GlobalFlood SDK metrics feature
...
class GlobalFloodMetricsFeature extends GlobalFloodBaseFeature
{
    ...
    private function _record(GlobalFloodContext $ctx, bool $ok): void
    {
