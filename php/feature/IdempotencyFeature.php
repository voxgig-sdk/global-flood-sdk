...
// GlobalFlood SDK idempotency feature
...
class GlobalFloodIdempotencyFeature extends GlobalFloodBaseFeature
{
    ...
    private function _mutating(GlobalFloodContext $ctx): bool
    {
