...
// GlobalFlood SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GlobalFloodTestFeature extends GlobalFloodBaseFeature
{
    ...
    public function init(GlobalFloodContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GlobalFloodContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = GlobalFloodParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GlobalFloodContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GlobalFloodContext $ctx, $op, $args): array
    {
