...
// GlobalFlood SDK clienttrack feature
...
class GlobalFloodClienttrackFeature extends GlobalFloodBaseFeature
{
    ...
    public function PostConstruct(GlobalFloodContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GlobalFlood-SDK';
