...
// GlobalFlood SDK telemetry feature
...
class GlobalFloodTelemetryFeature extends GlobalFloodBaseFeature
{
    ...
    private function _close(GlobalFloodContext $ctx, bool $ok): void
    {
