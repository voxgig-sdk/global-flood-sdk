...
// GlobalFlood SDK timeout feature
...
class GlobalFloodTimeoutFeature extends GlobalFloodBaseFeature
{
    ...
    private function _with_timeout(GlobalFloodContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GlobalFloodContext $_ctx, float $ms): void
    {
        $client = $this->client;
