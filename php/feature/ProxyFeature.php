...
class GlobalFloodProxyFeature extends GlobalFloodBaseFeature
{
    ...
    public function init(GlobalFloodContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GlobalFloodContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
