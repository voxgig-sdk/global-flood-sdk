...
// GlobalFlood SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GlobalFloodSDK::test)
...
{
    private const SDK_CLASS = 'GlobalFloodSDK';
    ...
    private const SDK_BASE = 'globalflood_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../globalflood_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
