...
// GlobalFlood SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class GlobalFloodTransformResponse
{
    public static function call(GlobalFloodContext $ctx): mixed
    {
        ...
        $transform = GlobalFloodHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
