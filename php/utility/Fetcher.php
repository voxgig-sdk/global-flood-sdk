...
// GlobalFlood SDK utility: fetcher

class GlobalFloodFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GlobalFloodSDK/1.0)';
    ...
    public static function call(GlobalFloodContext $ctx, string $fullurl, array $fetchdef): array
    {
