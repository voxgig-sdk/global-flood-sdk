...
// GlobalFlood SDK utility: graphql
//
...
class GlobalFloodGraphql
{
    ...
    // equivalent.
    public static function body(GlobalFloodContext $ctx): mixed
    {
    ...
    public static function errors(GlobalFloodContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
