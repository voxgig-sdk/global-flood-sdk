# GlobalFlood Lua SDK Reference

Complete API reference for the GlobalFlood Lua SDK.
...
```lua
local result, err = client:Flood():load({ latitude = "latitude", longitude = "longitude" })
```
