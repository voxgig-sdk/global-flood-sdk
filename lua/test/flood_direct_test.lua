...
describe("FloodDirect", function()
  it("should direct-load-flood", function()
    local setup = flood_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-flood", setup.live and "live" or "unit")
...
function flood_direct_setup(mockres)
