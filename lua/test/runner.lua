...
function runner.env_override(m)
  local live = runner.getenv("GLOBAL_FLOOD_TEST_LIVE")
  local override = runner.getenv("GLOBAL_FLOOD_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GLOBAL_FLOOD_TEST_EXPLAIN")
