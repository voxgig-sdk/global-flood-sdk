...
function runner.env_override(m)
  local live = runner.getenv("GLOBALFLOOD_TEST_LIVE")
  local override = runner.getenv("GLOBALFLOOD_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GLOBALFLOOD_TEST_EXPLAIN")
