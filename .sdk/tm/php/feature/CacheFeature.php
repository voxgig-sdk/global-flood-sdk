...
class GlobalFloodCacheFeature extends GlobalFloodBaseFeature
{
    ...
    private function _through(GlobalFloodContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
