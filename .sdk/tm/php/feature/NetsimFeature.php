...
// GlobalFlood SDK netsim feature
...
class GlobalFloodNetsimFeature extends GlobalFloodBaseFeature
{
    ...
    private function _simulate(GlobalFloodContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GlobalFloodContext $ctx, array $applied): void
    {
        $client = $this->client;
