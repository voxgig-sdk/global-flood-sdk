...
class GlobalFloodRbacFeature extends GlobalFloodBaseFeature
{
    ...
    private function _required(GlobalFloodContext $ctx): ?string
    {
    ...
    private function _reject(GlobalFloodContext $ctx, string $required): void
    {
    ...
    private function _track(GlobalFloodContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
