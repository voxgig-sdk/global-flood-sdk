...
// GlobalFlood SDK ratelimit feature
...
class GlobalFloodRatelimitFeature extends GlobalFloodBaseFeature
{
    ...
    private function _acquire(GlobalFloodContext $ctx): void
    {
    ...
    private function _track(GlobalFloodContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
