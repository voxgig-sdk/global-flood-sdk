...
// GlobalFlood SDK streaming feature
...
class GlobalFloodStreamingFeature extends GlobalFloodBaseFeature
{
    ...
    private function _iterate(GlobalFloodResult $result): \Generator
    {
    ...
    private function _streamable(GlobalFloodContext $ctx): bool
    {
