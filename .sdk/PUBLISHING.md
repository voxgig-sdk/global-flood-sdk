...
|---|---|---|
| `ts/` | @voxgig-sdk/global-flood-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/global-flood-sdk \
      --repository voxgig-sdk/global-flood-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/global-flood-sdk` shows it, and
`npm trust revoke @voxgig-sdk/global-flood-sdk --id=<id>` removes it.
