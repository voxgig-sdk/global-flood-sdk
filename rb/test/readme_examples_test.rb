...
#      offline in seeded test mode (GlobalFloodSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "GlobalFlood_sdk.rb")
  SDK_CLASS = "GlobalFloodSDK"
